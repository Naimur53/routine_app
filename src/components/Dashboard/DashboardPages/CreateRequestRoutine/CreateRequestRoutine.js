  ...
  return (
    <div className="">
      <button
        ...
        className="text-dark-purple mb-4 px-5 py-2 border rounded border-dark-purple"
      >
        Routine size {imgSize ? "Large" : "Normal"}
      </button>
      <div className="relative">
        <img
          className={!imgSize ? "w-auto  " : "w-full"}
          src={data.img}
          alt="routine"
        />
