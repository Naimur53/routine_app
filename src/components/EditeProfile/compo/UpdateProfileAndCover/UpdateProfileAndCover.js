...
const UpdateProfileAndCover = ({ edit, setEdit, updatable, setUpdatable }) => {
  ...
  const thumbnail = edit.status
    ? watch("thumbnail") || user.thumbnail
    : user.thumbnail;
        ...
        <div className="flex justify-center px-5  -mt-16">
          <div className="relative p-2 bg-gray-200 rounded-full">
            ...
            <Avatar
              ...
              src={
                edit.status ? watch("photoURL") || user.photoURL : user.photoURL
              }
            ...
            {edit.status ? (
              <div>
                <input
                  type="text"
                  autoFocus
                  className="text-gray-800 text-xl font-bold w-full text-center border border-gray-400 py-2 rounded-md"
              ...
              {edit.status ? (
                <div>
                  <textarea
                    ...
                    className="border border-gray-500 text-center w-full block px-2 py-2 rounded-md"
