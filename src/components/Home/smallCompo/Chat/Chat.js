    ...
    if (!user._id) {
        return (
            <div className='h-full bg-light-purple flex flex-col justify-center items-center'>
                <>
                    <img src={'https://i.ibb.co/R67R2J1/images-removebg-preview.png'} alt="" />
                    <h2 className='mb-2 text-md'>Login to send Message</h2>
                    <Button variant='outlined'><NavLink to='/login' className='text-dark-purple font-bold'>Login</NavLink></Button>
                </>
            </div>
        )
    }
