  ...
  return (
    <div className="h-full md:h-auto ">
      <div className="w-[85vw] md:w-full h-full">
        <div className="">
          {
            user?.email ? <div style={{
              backgroundImage: 'url(https://img.pikbest.com/backgrounds/20200615/ui-dot-line-purple-vector-background_2847590.jpg!c1024wm0)'
            }} className=" pb-4 bg-cover bg-center gap-2 fle x-col text- white pt-10 text-white shadow md:hidden px-3 items-center  " >

              <div to='/myProfile' className="p-1 mb-2 bg-transparent backdrop-blur-md rounded-full">
                <Avatar
                  component={NavLink}
              ...
              <div className="flex justify-between items-center w-full backdrop-blur-md rounded-xl ">
                <div className="bg-black/[.1] w-full  py-2 rounded-xl text-left pl-3 pr-1">
                  ...
                  <span className="block   capitalize font-medium ">{textConversion(user.displayName, 100)}</span>
                ...
                <IconButton component={NavLink} to='/editProfile' onClick={handleCloseNavMenu ? handleCloseNavMenu : () => { }} color="white" variant='outline'>
                  <EditIcon ></EditIcon>
                </IconButton>
              ...
              <div className="flex flex-col pb-0 items-center w-full">
                ...
                <h6 className="mt-2 mb-1 text-white text-sm">You are not logged in</h6>
              </div>
              <div className="flex  justify-between gap-2 items-start">
                <Button sx={{ backdropFilter: "blur(5px)" }} color="white" onClick={handleCloseNavMenu ? handleCloseNavMenu : () => { }} component={NavLink} to='/login' variant="outlined" className="bg-dark-purple text-white py-2 px-3 rounded-full " >Login</Button>
                <NavLink onClick={handleCloseNavMenu ? handleCloseNavMenu : () => { }} to='/signUp'><Button color="white" variant="contained" className="bg-dark-purple text-white py-2 px-3 rounded-full" >Register</Button></NavLink>
              </div>
            </div>
          }
        </div>
        ...
        {/* mobile */}
        <div className="pt-5 flex md:hidden justify-between gap-2 pr-5 pl-3 pb-0">
          {horizontalNav.slice(0, 3).map(({ name, path, Icon }, i) => (
            <NavLink
              ...
              to={path}
              className={({ isActive }) =>
                location?.pathname === path ? "dashboard_link_horizontal active_dashboard_link_horizontal"
